...
@Testcontainers
class CamundaOutboundIntegrationTest {
    ...
    void outbound_publishDelegate_sendsToNats() throws Exception {
        ...
        connection.createDispatcher().subscribe("camunda.out.test", msg ->
        ...
        delegate.setSubject(mockExpression("camunda.out.test"));
    ...
    void outbound_requestReply_workerResponds() throws Exception {
        // Start a worker
        connection.createDispatcher().subscribe("camunda.task.process", msg -> {
        ...
        delegate.setSubject(mockExpression("camunda.task.process"));
